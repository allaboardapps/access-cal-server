    ...
    context "with correct token" do
      ...
      describe "#create" do
        ...
        it "validates json attribute types" do
          ...
          expect_json_types("data", attributes: { 'street-address': :string })
          expect_json_types("data", attributes: { 'secondary-address': :string_or_null })
          ...
          expect_json_types("data", attributes: { 'starts-at': :date })
          expect_json_types("data", attributes: { 'ends-at': :date })
